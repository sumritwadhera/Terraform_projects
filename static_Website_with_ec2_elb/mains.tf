module "custum_vpc_mod" {
  source                = "../static_Website_with_ec2_elb/vpc_webrs"
...
module "s3_ec2_img" {
  source             = "../static_Website_with_ec2_elb/s3_webrs"
...
module "iam_role_ec2_s3" {
  source               = "../static_Website_with_ec2_elb/iam_webrs"
...
module "instance_public" {
  source                = "../static_Website_with_ec2_elb/webrs_instance"
...
module "alb_mod" {
  source = "../static_Website_with_ec2_elb/alb_webrs"
